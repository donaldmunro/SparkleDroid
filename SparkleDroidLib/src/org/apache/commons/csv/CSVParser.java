 ...
 * CSVParse parser = CSVParse.parse(csvData, CSVFormat.RFC4180);
 ...
 *
 * <pre>
 * CSVParse parser = CSVParse.parse(csvData, CSVFormat.EXCEL);
 * for (CSVRecord csvRecord : parser) {
 *     ...
 * }
 * </pre>
 ...
 * CSVParse parser = new CSVParse(in, CSVFormat.EXCEL);
 ...
 * </p>
 *
 * @version $Id: CSVParse.java 1524435 2013-09-18 14:57:57Z ggregory $
 *
    ...
    public Iterator<CSVRecord> iterator() {
        return new Iterator<CSVRecord>() {
            ...
            public CSVRecord next() {
                if (CSVParser.this.isClosed()) {
                    throw new NoSuchElementException("CSVParse has been closed");
                }
